...
public class pricecalculator2 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					pricecalculator2 window = new pricecalculator2();
	...
	private void initialize() {
		...
		frmAppolodineBeautyart.setTitle("Price Calculator");
		frmAppolodineBeautyart.setIconImage(Toolkit.getDefaultToolkit().getImage(pricecalculator2.class.getResource("/com/sun/java/swing/plaf/windows/icons/Computer.gif")));
